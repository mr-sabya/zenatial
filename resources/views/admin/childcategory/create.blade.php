    ...
    <div class="col-md-5">
        <div class="card">
            ...
            @include('partials.message')         
                <form action="{{route('admin-childcat-create')}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}  
                    <div class="form-group">
                        <label>Title</label>
                        <input type="text" id="cat-title" class="form-control" name="name" placeholder="Name of Childcategory" required="" value="">
                    </div>
                    <div class="form-group">
                        <label>Slug</label>
