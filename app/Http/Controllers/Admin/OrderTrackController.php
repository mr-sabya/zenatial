...
class OrderTrackController extends Controller
{
   ...
   //*** GET Request
    ...
    {
    	$data = OrderTrack::where('order_id', $id);
        return view('admin.orders.alltrack', compact('data'));
    }
   ...
   //*** GET Request
    public function load($id)
    {
        ...
        return view('admin.orders.track-load',compact('order'));
    }

    public function show($id)
    {
    	$data = Order::findOrFail($id);
        return view('admin.orders.track',compact('data'));
    }    
