...
class CartController extends Controller
{
    ...
    public function cart()
    {
        ...
        return view('frontend.cart', compact('products','totalPrice','mainTotal','tx')); 
    }
   ...
   public function addtocart($id)
    {
        $prod = Product::where('id','=',$id)->first(['id','user_id','slug','name','photo','size','size_qty','size_price','color','price','stock','type','file','link','measure','attributes']);
