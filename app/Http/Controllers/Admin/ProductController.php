...
class ProductController extends Controller
{
    ...
    public function index(Request $request, $status = null)
    {
        ...
        if($status != null){
            $datas = Product::search()->where('status', '=', $status)->latest()->paginate($per_page); 
        }else{
            $datas = Product::search()->latest()->paginate($per_page);  
        }        
        return view('admin.product.index', compact('datas', 'per_page'));
    }
