...
class CheckoutController extends Controller
{
    ...
    public function checkout()
    {
        ...
        if(Auth::guard('web')->check() || $gs->guest_checkout == 1)
        {
            ...
            // Shipping Method
            $default_shipping_cost = DB::table('shippings')->orderBy('id', 'asc')->take(1)->value('price');
            $shipping_data  = DB::table('shippings')->get();
            ...
            return view('frontend.checkout', ['products' => $cart->items, 'totalPrice' => $total, 'totalQty' => $cart->totalQty, 'gateways' => $gateways, 'shipping_cost' => 0, 'curr' => $curr,'default_shipping_cost' => $default_shipping_cost, 'shipping_data' => $shipping_data]);             
        }else{
