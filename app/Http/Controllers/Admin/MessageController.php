...
class MessageController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $datas = AdminUserConversation::where('type','=','Ticket')->latest()->paginate($per_page);        
        return view('admin.message.index', compact('datas', 'per_page'));            
    }
    ...
    public function disputes(Request $request)
    {
        ...
        Cookie::queue('entries', $per_page);
        $datas = AdminUserConversation::where('type','=','Dispute')->latest()->paginate($per_page);
        return view('admin.message.dispute', compact('datas', 'per_page'));                  
    }
